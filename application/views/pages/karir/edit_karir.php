        ...
        <div class="container" style="padding-bottom: 20px; border: 1px solid #bcbcbc; border-radius: 12px; padding: 20px;">
            <form id="form-edit-loker" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    <label for="kategori" class="col-form-label col-sm-2">Kategori <span style="color:red;">*</span></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kategori" name="kategori" value="<?= $loker['kategori'] ?>" required>
                    </div>
                </div>
                <div class="form-group row">
